...
| `jspdf.umd.min.js` | jsPDF | 3.0.1 | Bumped from 2.5.2 — closes the prototype-pollution advisory below. |
...
The 2.5.x line had a prototype-pollution advisory (**GHSA-w532-jxjh-hjhj**, fixed in jsPDF
**3.0.1**). Real-world risk here was low (jsPDF only runs at *export* time on data the user
already controls), but it's now closed. Paired with svg2pdf.js **2.5.0** (declares jsPDF
